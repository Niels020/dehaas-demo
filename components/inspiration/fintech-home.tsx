		...
		>
			...
			<header className="sticky top-0 z-20 border-b border-[#e8efec] bg-white/90 backdrop-blur">
				<div className="flex items-center justify-between px-12 py-4">
					...
					<nav className="flex gap-8 text-sm font-medium text-[#5c6f68]">
			...
			{/* Hero */}
			<section className="grid grid-cols-2 items-center gap-12 overflow-hidden bg-gradient-to-b from-[#f2faf6] to-white px-12 py-20">
				<div>
					...
					<p className="mt-6 max-w-md text-lg leading-relaxed text-[#5c6f68]">
				...
				<div className="relative flex items-center justify-center">
					...
					<div className="relative w-full max-w-sm">
						...
						{/* Floating bank card */}
						<div className="absolute -bottom-10 -right-6 w-60 rotate-6 rounded-2xl bg-gradient-to-br from-[#10231c] to-[#1d4536] p-5 text-white shadow-2xl">
							<div className="flex items-center justify-between">
			...
			{/* Trust strip */}
			<section className="border-y border-[#e8efec] px-12 py-8">
				<div className="flex items-center justify-center gap-10 text-sm font-semibold tracking-wide text-[#8aa098]">
			...
			<section className="grid grid-cols-2 items-center gap-16 bg-[#10231c] px-12 py-24 text-white">
			...
			{/* In-person payments */}
			<section className="grid grid-cols-2 items-center gap-16 px-12 py-24">
				<div>
					...
					<div className="mt-8 grid grid-cols-3 gap-6 border-t border-[#e8efec] pt-8 text-center">
						{[
			...
			<section className="px-12 pb-24">
				<div className="rounded-3xl bg-gradient-to-br from-[#0bbf7d] to-[#078b5b] px-14 py-16 text-center text-white">
					<h2 className="text-4xl font-extrabold tracking-tight">
			...
			{/* Footer */}
			<footer className="border-t border-[#e8efec] px-12 py-10">
				<div className="flex items-center justify-between">
					...
					<nav className="flex gap-8 text-sm text-[#8aa098]">
						<a href="#" className="hover:text-[#10231c] transition-colors">
							Security
						</a>
						<a href="#" className="hover:text-[#10231c] transition-colors">
