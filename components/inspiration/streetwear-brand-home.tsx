...
export function StreetwearBrandHome() {
	return (
		...
		>
			<header className="flex items-center justify-between border-b border-[#2a2a2a] bg-[#0d0d0d] px-4 sm:px-6 md:px-8 py-4">
				<a href="#" className="text-2xl font-black tracking-[0.5em] text-[#f5f5f5]">
					VOID
				</a>
				<nav className="hidden md:flex items-center gap-4 text-[10px] uppercase tracking-[0.3em] text-[#666666]">
			...
			<section className="relative min-h-[480px] sm:min-h-[600px] md:min-h-[700px] overflow-hidden">
				<Image
				...
				/>
				<div className="absolute inset-0 z-10 flex flex-col justify-end p-6 sm:p-8 md:p-12">
					<p className="absolute top-4 right-4 sm:top-8 sm:right-8 text-[10px] uppercase tracking-[0.4em] text-[#666666]">
						DROP 003 — SS25
					</p>
					<div>
						<h1 className="text-5xl sm:text-7xl md:text-[96px] font-black leading-none tracking-tighter text-[#f5f5f5]">
							LIMITED
						</h1>
						<h1 className="text-5xl sm:text-7xl md:text-[96px] font-black leading-none tracking-tighter text-[#c8ff00]">
							EDITION
						</h1>
			...
			<section className="bg-[#0d0d0d] px-4 sm:px-6 md:px-8 py-12 sm:py-16">
			...
			<section className="grid grid-cols-1 md:grid-cols-[220px_1fr] items-start gap-4 md:gap-8 border-t border-[#2a2a2a] bg-[#0d0d0d] px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-24">
				<div aria-hidden="true" className="hidden md:block select-none text-[200px] leading-none text-[#1a1a1a]">
					/
				</div>
				<div className="pt-6">
					<h2 className="text-3xl sm:text-4xl font-black leading-none text-[#f5f5f5]">
						WE DON&apos;T FOLLOW
					</h2>
					<h2 className="text-3xl sm:text-4xl font-black leading-none text-[#c8ff00]">
						TRENDS.
					</h2>
			...
			<section className="bg-[#c8ff00] py-3">
				<div className="flex gap-12 overflow-hidden whitespace-nowrap px-4 sm:px-6 md:px-8 text-xs font-black uppercase tracking-[0.3em] text-[#0d0d0d]">
			...
			<section className="grid grid-cols-1 sm:grid-cols-3 gap-8 border-t border-[#2a2a2a] bg-[#1a1a1a] px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20">
				{values.map((value) => (
			...
			<section className="border-t border-[#2a2a2a] bg-[#0d0d0d] px-4 sm:px-6 md:px-8 py-12 sm:py-16">
				<div className="mx-auto grid max-w-3xl grid-cols-1 sm:grid-cols-2 items-start sm:items-end gap-8">
					<div>
			...
			<footer className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-[#2a2a2a] bg-[#0d0d0d] px-4 sm:px-6 md:px-8 py-10 text-center">
				<a href="#" className="text-xl font-black tracking-[0.5em] text-[#f5f5f5]">
					VOID
				</a>
				<nav className="flex flex-wrap items-center justify-center gap-3 text-[10px] tracking-[0.3em] text-[#666666]">
