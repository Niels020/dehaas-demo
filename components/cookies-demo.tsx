									...
									<div className="flex items-start gap-4">
										...
										<div className="flex-1 space-y-3">
											...
											<p className="text-sm text-muted-foreground leading-relaxed">
												...
												experience. We use cookies for analytics,
												personalization, and advertising. You can choose to
							...
							<div className="fixed z-[60] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md rounded-xl border border-border bg-card shadow-2xl">
								...
								<div className="p-5 space-y-4">
									...
									<div className="flex items-center justify-between">
										...
										>
											<div
												className={`h-4 w-4 rounded-full transition-colors ${analytics ? "bg-primary-foreground" : "bg-muted-foreground/50"}`}
											/>
										</button>
									</div>
									...
									<div className="flex items-center justify-between">
										...
										>
											<div
												className={`h-4 w-4 rounded-full transition-colors ${marketing ? "bg-primary-foreground" : "bg-muted-foreground/50"}`}
											/>
										</button>
									</div>
									...
									<div className="flex items-center justify-between">
										...
										>
											<div
												className={`h-4 w-4 rounded-full transition-colors ${functional ? "bg-primary-foreground" : "bg-muted-foreground/50"}`}
											/>
										</button>
									</div>
